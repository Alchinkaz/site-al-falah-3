...
export default function HomepageAdminPage() {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        console.log("[v0] Loading homepage data...")
        setIsLoading(true)
  ...
  const handleSave = async () => {
    ...
    try {
      console.log("[v0] Saving homepage data...")
      ...
      console.log("[v0] Homepage data saved successfully")
      ...
      console.error("[v0] Error saving homepage data:", error)
