...
export default function AdminPortfolioPage() {
  ...
  useEffect(() => {
    const loadTranslations = async () => {
      try {
        console.log("[v0] Loading portfolio translations...")
        setIsLoading(true)
        ...
        if (res.ok) {
          ...
          console.log("[v0] Loaded portfolio translations:", translations.portfolioI18n)
        ...
        console.error("[v0] Error loading portfolio translations:", error)
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      console.error("[v0] Portfolio save error:", e)
