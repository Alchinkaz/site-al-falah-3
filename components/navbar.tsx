  ...
  useEffect(() => {
    const loadTranslations = async () => {
      try {
        ...
        console.error("[v0] Error loading navbar translations:", error)
      }
    }
    loadTranslations()
    ...
    const handleI18nUpdate = async () => {
      try {
        ...
        console.error("[v0] Error reloading navbar translations:", error)
      }
    }
  ...
  const navItems = [
    {
      href: "/",
      label:
        translations?.navHome?.[language] || (language === "ru" ? "Главная" : language === "kz" ? "Басты бет" : "Home"),
    },
    {
      href: "/about",
      label:
