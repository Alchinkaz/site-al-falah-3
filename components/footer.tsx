...
export default function Footer({ homepageData: initialHomepageData }: { homepageData?: HomepageData | null } = {}) {
  ...
  useEffect(() => {
    const loadTranslations = async () => {
      try {
        ...
        console.error("[v0] Error loading footer translations:", error)
      }
    }
    loadTranslations()
    ...
    const handleI18nUpdate = async () => {
      try {
        ...
        console.error("[v0] Error reloading footer translations:", error)
      }
    }
  ...
  useEffect(() => {
    ...
    const onData = async (e: any) => {
      try {
        ...
        console.error("[v0] Error reloading footer data:", error)
      }
    }
  ...
  const [ctaLine1 = "", ctaLine2 = ""] = Array.isArray(ctaTitleData) ? ctaTitleData : []
